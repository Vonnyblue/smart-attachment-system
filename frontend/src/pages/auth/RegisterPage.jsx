    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-gray-600">Set up a student or admin workspace for the demo</p>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white/90"
                >
              ...
              <Input
                ...
                value={formData.bio}
                onChange={handleChange}
                placeholder="Tell us what this account is for"
                className="bg-white/90"
              />
